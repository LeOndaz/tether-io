...
import { IndexEncoder, b4a, c } from 'hyperdb/runtime'
import { getEncoding, setVersion, version } from './messages.js'
...
const index3_key = new IndexEncoder([IndexEncoder.STRING], { prefix: 3 })
...
const index5_key = new IndexEncoder([IndexEncoder.STRING, IndexEncoder.STRING], { prefix: 5 })
...
function resolveCollection(name) {
  switch (name) {
    case '@aipaas/apiKeys':
      return collection0
    case '@aipaas/deployments':
      return collection1
    case '@aipaas/usageRecords':
      return collection2
    default:
      return null
  }
...
function resolveIndex(name) {
  switch (name) {
    case '@aipaas/apiKeys-by-hash':
      return index3
    case '@aipaas/deployments-by-model':
      return index4
    case '@aipaas/usageRecords-by-keyId':
      return index5
    case '@aipaas/usageRecords-by-model':
      return index6
    default:
      return null
  }
